...
class SingleBattleScreen1 extends StatelessWidget {
  final int pattern;

  SingleBattleScreen1({super.key, required this.pattern});
  ...
  Future<Map<String, dynamic>> _fetchBattleResult({
    ...
    final url = Uri.parse('http://localhost:8000/battle/pattern1');
